    ...
    <body>
        <%
            ...
            if (sessionCensus.getAttribute("usuario") != null) {
                if (((LinkedList) sessionCensus.getAttribute("permisosUsuario")).contains("consultarVehiculo.jsp")) {
                                                ...
                                                <div id="tabs">
                                                    ...
                                                    <div id="tabs-1">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <label></label>
                                                                <button type="button" class="btn btn-md btn-primary btn-block" id="btnconsultarreferencia" name="btnconsultarreferencia" >Consultar</button>
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <label></label>
                                                    ...
                                                    <div id="tabs-2">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <button type="button" class="btn btn-md btn-primary btn-block" onclick="consultarListadoVehiculo(2)" id="btnconsultardocumento" name="btnconsultardocumento" >Consultar</button>
                                                            </div>
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                    ...
                                                    <div id="tabs-3">
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input class="form-control" type="text" id="txtfechaRegini" name="txtfechaRegini" readonly="true" value="<%=new SimpleDateFormat("dd/MM/yyyy").format(fechaActual)%>"/>
                                                        </div>
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            <label>Fecha Final</label>
                                                            <input class="form-control" type="text" id="txtfechaRegfin" name="txtfechaRegfin" readonly="true" value="<%=new SimpleDateFormat("dd/MM/yyyy").format(fechaActual)%>"/>
                                                        </div>
                                                        <div class="col-sm-6 mb-3 mb-sm-0">

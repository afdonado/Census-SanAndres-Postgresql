                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                %>
                                <c:choose>
                                    <c:when test="${vehiculo.PAIS_MATRICULA != null}">
                                        <c:when test="${vehiculo.PAIS_MATRICULA != null && vehiculo.PAIS_MATRICULA == 'COLOMBIA'}">
                                            <p>El país de matrícula es COLOMBIA.</p>
                                        </c:when>
                                    </c:when>
                                </c:choose> 
                                <!-- Verifica si PAIS_MATRICULA es COLOMBIA -->
                                <c:if test="${vehiculo.PAIS_MATRICULA == 'COLOMBIA'}">

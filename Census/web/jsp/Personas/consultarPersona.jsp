...
<html>
    <head>
        ...
        <script>
            ...
            $(function () {
                $("#txtfechanacini").datepicker();
            });
            $(function () {
                $("#txtfechanacfin").datepicker();
            });
        </script>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">Personas - Consultar Personas</h1>
                </div>
            </div>
                        ...
                        <div id="tabs">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input class="form-control" type="text" id="txtdocumento" name="txtdocumento" onKeyPress=" return validarNumeros(event)" maxlength="20" style="text-transform: uppercase">
                                            </div>
                                            <div class="col-md-2">
                                                <label></label>
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReportePersona(1)">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReportePersona(2)">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" type="text" id="txtfechanacini" name="txtfechanacini" readonly="true" value="<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(fechaActual)%>"/>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Fecha Final</label>
                                                <input class="form-control" type="text" id="txtfechanacfin" name="txtfechanacfin" readonly="true" value="<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(fechaActual)%>"/>
                                            </div>
                                            <div class="col-md-2">
                                                <label></label>
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReportePersona(3)">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tabs-4">
                                <div class="row">
                                    <div class="col-md-2">
                                        <label></label>
                                        <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReportePersona(4)">Generar Reporte</button>
                                    </div>
                                </div>
                            </div>
                        </div>

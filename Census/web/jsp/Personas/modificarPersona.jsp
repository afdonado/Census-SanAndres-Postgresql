    ...
    <body>
        <%
            ...
            if (sessionCensus.getAttribute("usuario") != null) {
                if (((LinkedList) sessionCensus.getAttribute("permisosUsuario")).contains("modificarPersona.jsp")) {
        %>
        <div id="wrapper">
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <h1 class="h3 mb-2 text-gray-800">Modificar Persona</h1>
                            <form class="user" id="frmmodificarpersona">
        ...
        <script src="${pageContext.request.contextPath}/scripts/modificarPersona.js" type="text/javascript"></script>

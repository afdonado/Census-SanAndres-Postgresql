            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <%
                       ...
                       if( cenverificacion==null || (cenverificacion!=null && cenverificacion.getEstado() == 1)){
                           
                    %>
                    <div class="row page-header">
                        <div class="form-group col-xs-12 col-sm-3 col-md-3">
                            <button type="button" class="btn btn-lg btn-info btn-block" onclick="verificar()" id="btnverificar" name="btnverificar" >Verificar</button>
                        </div>
                    </div>
                    <%
                    }

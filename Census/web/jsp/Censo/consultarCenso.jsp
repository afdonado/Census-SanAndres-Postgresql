...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">Censo - Consultar Censo</h1>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div id="tabs">
                            <ul>
                                ...
                                <li><a href="#tabs-6">Reporte General</a></li>
                            </ul>
                            <div id="tabs-0">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(0)" id="btngenerarreporte">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(1)" id="btngenerarreporte">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(2)" id="btngenerarreporte">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(3)" id="btngenerarreporte">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label></label>
                                                <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(4)" id="btngenerarreporte">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tabs-5">
                                <div class="row">
                                    <div class="col-md-2">
                                        <label></label>
                                        <button type="button" class="btn btn-md btn-success btn-block" onclick="generarReporteCenso(5)" style="cursor: pointer;">Generar Reporte</button>
                                    </div>
                                </div>
                            </div>
                        </div>

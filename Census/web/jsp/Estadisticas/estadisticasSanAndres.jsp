...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>Estadisticas San Andres</title>
        ...
        <script src="../../scripts/estadisticasSanAndres.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            if (session.getAttribute("usuario") != null) {
                if (((java.util.LinkedList) session.getAttribute("permisosUsuario")).contains("estadisticasSanAndres.jsp")) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">Census - Estadisticas San Andres</h1>
                </div>
            </div>
            <div class="row">
                ...
                <div id="tablaClaseVeh" class="col-md-4">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosClaseVeh = estadisticaDao.ListarCantidadCensosClaveVehiculoSanAndres();
            ...
            <div class="row">
                <div id="tablaPersonasLicencia" class="col-md-6">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosPersonasLicencia = estadisticaDao.ListarCantidadPersonasCensadasLicenciaSanAndres();
                ...
                <div id="tablaPersonasGenero" class="col-md-6">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosPersonasGenero = estadisticaDao.ListarCantidadPersonasCensadasGeneroSanAndres();
            ...
            <div class="row">
                ...
                <div id="tablaVehiculosPlacas" class="col-md-6">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosVehiculosPlacas = estadisticaDao.ListarCantidadVehiculosPlacaSanAndres();
            ...
            <div class="row">
                <div id="tablaVehiculoSoat" class="col-md-6">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosVehSoat = estadisticaDao.ListarCantidadVehiculosSoatSanAndres();
                ...
                <div id="tablaVehiculoTecno" class="col-md-6">
                    <table class="table table-condensed" >
                        ...
                        <tbody>
                            <%
                                List<HashMap> datosVehTecno = estadisticaDao.ListarCantidadVehiculosTecnoSanAndres();

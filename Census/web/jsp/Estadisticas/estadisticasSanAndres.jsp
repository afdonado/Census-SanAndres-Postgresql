...
<html>
    ...
    <body id="page-top">
                            ...
                            <div class="row">
                                ...
                                <div id="tablaClaseVeh" class="col-md-4">
                                    <table class="table table-condensed" >
                                        ...
                                        <tbody>
                                        <%
                                            List<HashMap> datosClaseVeh = estadisticaDao.ListarCantidadCensosClaveVehiculoSanAndres(conex);
                        ...
                        <div class="row">
                            <div id="tablaPersonasLicencia" class="col-md-6">
                                <table class="table table-condensed" >
                                    ...
                                    <tbody>
                                        <%
                                            List<HashMap> datosPersonasLicencia = estadisticaDao.ListarCantidadPersonasCensadasLicenciaSanAndres(conex);
                            ...
                            <div id="tablaPersonasGenero" class="col-md-6">
                                <table class="table table-condensed" >
                                    ...
                                    <tbody>
                                        <%
                                            List<HashMap> datosPersonasGenero = estadisticaDao.ListarCantidadPersonasCensadasGeneroSanAndres(conex);
                        ...
                        <div class="row">
                            <div id="tablaVehiculosPlacas" class="col-md-6">
                                <table class="table table-condensed" >
                                    ...
                                    <tbody>
                                        <%
                                            List<HashMap> datosVehiculosPlacas = estadisticaDao.ListarCantidadVehiculosPlacaSanAndres(conex);
                        ...
                        <div class="row">
                            <div id="tablaVehiculoSoat" class="col-md-6">
                                <table class="table table-condensed" >
                                    ...
                                    <tbody>
                                        <%
                                            List<HashMap> datosVehSoat = estadisticaDao.ListarCantidadVehiculosSoatSanAndres(conex);
                            ...
                            <div id="tablaVehiculoTecno" class="col-md-6">
                                <table class="table table-condensed" >
                                    ...
                                    <tbody>
                                        <%
                                            List<HashMap> datosVehTecno = estadisticaDao.ListarCantidadVehiculosTecnoSanAndres(conex);
        ...
        <script src="${pageContext.request.contextPath}/scripts/estadisticasSanAndres.js" type="text/javascript"></script>
    </body>
</html>
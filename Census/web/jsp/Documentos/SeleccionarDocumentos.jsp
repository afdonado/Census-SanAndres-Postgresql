                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <form role="form" id="frmcargardocumentos" enctype="multipart/form-data" onsubmit="checkSubmit('btncargar', 'Guardando...')" action="../../cargarDocumentos?idcenso=<%=idcenso%>&numero=<%=numero%>" method="post">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Seleccione Documentos</h6>
                                </div>
                                <div class="card-body">

...
@WebServlet(name = "CargarPerfiles", urlPatterns = {"/cargarPerfiles"})
public class CargarPerfiles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conex = dataSource.getConnection()) {
            ...
            List<CenPerfil> lista = usuarioDao.ListarPerfiles(conex);
            ...
            out.println("alert('Error al cargar los perfiles');");

...
public class ActualizarPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!request.getParameter("idusuario").equals("") && !request.getParameter("txtpass").equals("")) {
                
                newpass = DigestUtils.md5Hex(request.getParameter("txtpass"));
                
                idusuario = Long.parseLong(request.getParameter("idusuario"));

                dao.restaurarPasswordUsuario(idusuario, newpass);
            }
            ...
            out.println("location='jsp/../cerrarSesion';");
            out.println("</script>");
        } catch (Exception e) {
            e.printStackTrace();
        }

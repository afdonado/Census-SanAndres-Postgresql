...
public class UsuarioDao extends Conexion {
    ...
    public CenUsuario ConsultarUsuario(String usuario, String pass, int estado) throws SQLException, IOException {
    ...
    public List ListarPermisosById(long id) throws SQLException, IOException {
        ...
        try(Connection conex = conectar()) {
            ...
            throw new SQLException("Error en ListarPermisosByIdUsuario: " + e);
        } finally {
            if (rst != null) {
                try {
                    rst.close();
    ...
    public List ListarModulosByUsuario(long id) throws SQLException, IOException {
    ...
    public List<CenModulo> ListarModulos() throws SQLException {
    ...
    public long adicionarUsuario(CenUsuario cenusuario) throws SQLException, IOException{
        ...
        try(Connection conex = conectar()) {
            ...
            pst.setString(2, cenusuario.getPass());
            ...
            try {
                ...
                System.err.println("Error en cierres de adicionarUsuario: " + e);
            }
        }
        return 0;
    }

    public CenUsuario ConsultarUsuarioByNombre(String nomusuario) throws SQLException {
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de consultarUsuarioByNombre: " + e);
            }
        }
        return null;
    }

    public List ListarPermisosByUsuarioModulo(long id, int idmodulo) throws SQLException {
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de ListarPermisosByUsuarioModulo: " + e);
            }
        }
        return listaPermisos;
    }

    public CenUsuario ConsultarUsuarioById(long id) throws SQLException {
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de ConsultarUsuarioById: " + e);
            }
        }
        return null;
    }

    public void modificarUsuario(CenUsuario cenusuario) throws SQLException, IOException {

        try(Connection conex = conectar()) {
            pst = conex.prepareStatement("UPDATE CEN_USUARIOS SET USU_PASS = ?,USU_FECHAFINAL = ?,EST_ID = ? WHERE USU_ID = ? ");
            pst.setString(1, cenusuario.getPass());
    ...
    public void restaurarPasswordUsuario(long id, String newpass) throws SQLException, IOException {
    ...
    public java.util.List ListarUsuariosByNombre(String nombre) throws SQLException {
    ...
    public java.util.List ListarUsuariosByPersona(int tipodoc, String documento) throws SQLException {
    ...
    public java.util.List ListarUsuariosByPunto(int punto) throws SQLException {
    ...
    public CenPerfilUsuario ConsultarPerfilUsuarioByIdUsuario(long id) throws SQLException {
    ...
    public java.util.List ListarPerfiles() throws SQLException {

        java.util.List listaPerfil = new java.util.LinkedList();
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de ListarPerfiles: " + e);
            }
        }
        return listaPerfil;
    }

    public CenPerfil ConsultarPerfilById(int id) throws SQLException {
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de ConsultarPerfilById: " + e);
            }
        }
        return null;
    }
    
    public long adicionarPerfilUsuario(CenPerfilUsuario cenperfilusuario) {
        ...
        try(Connection conex = conectar()) {
            ...
            try {
                ...
                System.err.println("Error en cierres de adicionarPerfilUsuario: " + e);
            }
        }
        return 0;
    }

    public void modificarPerfilUsuario(CenPerfilUsuario cenperfilusuario) throws SQLException, IOException {

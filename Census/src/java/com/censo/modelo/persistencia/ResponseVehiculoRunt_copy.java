...
@Builder
@ToString
public class ResponseVehiculoRunt_copy {

    private RuntPlacaVO runtPlacaVO;
    ...
    @Builder
    @ToString
    public static class RuntPlacaVO {
    ...
    public static ResponseVehiculoRunt_copy load(ResultSet rs) throws SQLException {
        ResponseVehiculoRunt_copy vehiculoRunt = ResponseVehiculoRunt_copy.builder()
                .runtPlacaVO(ResponseVehiculoRunt_copy.RuntPlacaVO.builder()
                        ...
                        .informacionGeneralVehiculo(ResponseVehiculoRunt_copy.RuntPlacaVO.InformacionGeneralVehiculo.builder()
                                        ...
                                        .build())
                        .datosTecnicosVehiculo(ResponseVehiculoRunt_copy.RuntPlacaVO.DatosTecnicosVehiculo.builder()
                                        ...
                                        .build())
                        .listPolizaSoat(List.of(ResponseVehiculoRunt_copy.RuntPlacaVO.PolizaSoat.builder()
                                        ...
                                        .build()))
                        .listCertificadoTecnicoMecanicoGases(List.of(ResponseVehiculoRunt_copy.RuntPlacaVO.CertificadoTecnicoMecanicoGases.builder()

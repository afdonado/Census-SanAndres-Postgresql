...
public class ResponseVehiculoRunt {
    ...
    public static ResponseVehiculoRunt load(ResultSet rs) throws SQLException {
        ResponseVehiculoRunt vehiculoRunt = ResponseVehiculoRunt.builder()
                .runtPlacaVO(ResponseVehiculoRunt.RuntPlacaVO.builder()
                        ...
                        .informacionGeneralVehiculo(ResponseVehiculoRunt.RuntPlacaVO.InformacionGeneralVehiculo.builder()
                                        ...
                                        .build())
                        .datosTecnicosVehiculo(ResponseVehiculoRunt.RuntPlacaVO.DatosTecnicosVehiculo.builder()
                                        ...
                                        .build())
                        .listPolizaSoat(List.of(ResponseVehiculoRunt.RuntPlacaVO.PolizaSoat.builder()
                                        ...
                                        .build()))
                        .listCertificadoTecnicoMecanicoGases(List.of(ResponseVehiculoRunt.RuntPlacaVO.CertificadoTecnicoMecanicoGases.builder()
